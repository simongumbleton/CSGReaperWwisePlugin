...
void WwiseTemplateComponent::InitTreeView()
{
...
void WwiseTemplateComponent::ApplySettingsToSelectedJobs() {
...
void WwiseTemplateComponent::TryConnectToWwise() {
	...
	if ((connected)&&(MyCurrentWwiseConnection->projectGlobals.ProjectPath != ""))
	{
		...
		WwiseCntnHndlr->SubscribeOnSelectionChanged(WwiseTemplateComponent::callback_OnSelectionChanged, 1);
		WwiseCntnHndlr->SubscribeOnProjectClosed(WwiseTemplateComponent::callback_OnProjectClosed, 2);
		InitComboBox(dd_Language, MyCurrentWwiseConnection->projectGlobals.Languages, "Language..");
...
bool WwiseTemplateComponent::CheckIsVoice() {
...
bool WwiseTemplateComponent::CheckOriginalsDirectory() {
...
void WwiseTemplateComponent::RefreshRenderJobTree()
{
...
void WwiseTemplateComponent::handleUI_B_CreateObject()
{
